...
def compare_percentile_ranges(csv_file1, csv_file2, output_dir):
    ...
    # データセット別の色設定
    dataset_colors = {'20251019_232450': '#2E8B57', '20251001_211526': '#FF6347'}  # 緑とオレンジ
    ...
    datasets = [
        (df1, '20251019_232450', 'Dataset 1 (2025/10/19)'),
    ...
    for df, dataset_name, dataset_label in datasets:
        for protocol in ['HTTP/2', 'HTTP/3']:
            ...
            line_style = '-' if dataset_name == '20251019_232450' else '--'
            marker_style = 'o' if dataset_name == '20251019_232450' else 's'
    ...
    plt.tight_layout()
    output_file = os.path.join(output_dir, 'percentile_range_comparison_20251019_20251001.png')
...
if __name__ == "__main__":
    # 指定されたCSVファイル
    csv_file1 = 'logs/20251019_232450/benchmark_results.csv'
